...
REF;
	...
	if ((int) ini_get('short_open_tag') == '0')
        ...
        if (!file_exists('include/secrets.local.php')) {
            die('создайте файл include/secrets.local.php; в него переместите свои локальные настройки из include/secrets.php (техническое требование)');
        }
        if (!file_exists('include/config.local.php')) {
            die('создайте файл include/config.local.php; в него переместите свои локальные настройки из include/config.php (техническое требование)');
        }
